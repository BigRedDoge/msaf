...
plot_rcparams = {
    ...
    "font.monospace": ["Source Code Pro", "Courier", "Fixed", "Terminal", "monospace"],
}
...
latex_documents = [
    ("index", "msaf.tex", "msaf Documentation", "The msaf development team", "manual"),
]
...
man_pages = [("index", "msaf", "msaf Documentation", ["The msaf development team"], 1)]
